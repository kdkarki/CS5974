...
#define nl 5000       /* element pool length                 */
#define ns 256       /* namespace length                    */
#define pl 58        /* printer page length   (lines used   */
#define sl 23        /* screen page length     by 'smpl')   */
#define FF 12        /* form feed                           */

static int rept_page(int);
static int save_name(char*,int);
static void end_line();
static void enlist(int*,int);
static void enqueue(int,int,int,int,real);
static void msg(int,int,char*,int,int);
static void resetf();
...
/*-------------------------  ENQUEUE TOKEN  --------------------------*/
static void enqueue(f,j,pri,ev,te)
